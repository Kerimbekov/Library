...
namespace Library.Controllers
{
    public class ReadersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReaderId,Name,Adress,BiletId,BirthYear,PhomeNumber")] Reader reader)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReaderId,Name,Adress,BiletId,BirthYear,PhomeNumber")] Reader reader)
        {
